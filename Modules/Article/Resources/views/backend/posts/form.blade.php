<div class="row mb-3">
    ...
    <div class="col-4">
        <div class="form-group">
            ...
            $required = '';
            $default_value = Auth::user()->name;
            ?>
            {{ html()->label($field_label, $field_name) }} {!! fielf_required($required) !!}
            {{ html()->text($field_name)->placeholder($field_placeholder)->class('form-control')->attributes(["$required", 'value' => $default_value]) }}
        </div>
    </div>
...
<div class="row mb-3" style="display: none">
    <div class="col-12">
        <div class="form-group">
            ...
            ?>
            {{ html()->label($field_lable, $field_name) }} {!! fielf_required($required) !!}
            {{ html()->textarea($field_name)->placeholder($field_placeholder)->class('form-control')->attributes(["$required"])->value($default_value) }}
        </div>
    </div>
</div>
<div class="row mb-3">
    <div class="col-12" style="display: none">
        <div class="form-group">
            ...
            $required = '';
            $default_value = 'path_to_default_image.jpg';
            ?>

            <div class="form-group">
                {{ html()->label($field_label, $field_name) }} {!! fielf_required($required) !!}
                <div class="input-group mb-3">
                    {{ html()->text($field_name)->placeholder($field_placeholder)->class('form-control')->attributes(["$required", 'aria-label' => 'Image', 'aria-describedby' => 'button-image'])->value($default_value) }}
                    <div class="input-group-append">
                        <button class="btn btn-info" type="button" id="button-image" data-input="{{ $field_name }}">
    ...
    <div class="row mb-3">
        ...
        <div class=" col-4" style="display: none">
            <div class="form-group">
                ...
                ?>
                {{ html()->label($field_label, $field_name) }} {!! fielf_required($required) !!}
                {{ html()->select($field_name, $select_options)->placeholder($field_placeholder)->class('form-select')->attributes(["$required"])->value($default_value) }}
            </div>
        </div>
        <div class="col-4">
            <div class="form-group">
                ...
                $field_lable = __('Barang');
                $field_relation = 'tags';
                $field_placeholder = __('Select Barang');
                $required = 'required';
                ?>
                {{ html()->label($field_lable, $field_name) }} {!! fielf_required($required) !!}
                {{ html()->multiselect(
    ...
    <div class="row mb-3">
        <div class="col-6">
            <div class="form-group">
                <?php
                $field_name = 'status';
                $field_lable = __('Status Pembayaran');
                $field_placeholder = __('Select an option');
                $required = 'required';
                $select_options = [
                    '1' => 'Paid',
    ...
    @push('after-scripts')
        ...
        <script type="module">
            $(document).ready(function() {
                // Bind an input event to the 'name' field
